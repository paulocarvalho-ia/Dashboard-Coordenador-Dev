...
# ============================================================
# FILTROS NO TOPO (DENTRO DE EXPANDER)
# ============================================================
...
# ============================================================
    ...
    if not df_softys.empty:
        ...
        fig_softys.add_trace(go.Bar(
            x=graph_df[graph_df['Mês'] != 'YTD']['Mês'],
            y=graph_df[graph_df['Mês'] != 'YTD']['Clientes'],
            name='Mensal',
            marker_color='#2E8B57'
        ))
        fig_softys.add_trace(go.Bar(
        ...
        fig_softys.update_layout(title='Positivação Softys Falcon (Mensal + YTD)', barmode='group')
